                                    ...
                                    <div class="col-lg-12 col-sm-12 col-12 form-input">
                                        <form class="border p-3 form" method = "get" action = "../BuscarAdministradorSistema">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label text-left" for="usuario" style = "font-size:20px">Clave:</label> <!--for="email"-->
                                                <div class="col-sm-9">
                                                    <input type="password" name="txtUsuario" id="usuario" class="form-control" placeholder="Ingresa la clave para acceder...">
                                                    <!--id="email"-->
                                                </div>
                                            </div>
                                            <div class="form-row">
