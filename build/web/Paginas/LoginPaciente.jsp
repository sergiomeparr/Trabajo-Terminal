                ...
                <div class="modal-dialog">
                    ...
                    <div class="col-lg-12 col-sm-12 col-12 main-section">
                        <div class="col-lg-12 col-sm-12 col-12 user-img">
                            <img class="icono-img" src="http://contraloriadelmagdalena.gov.co/contratacion/imagenes/botones/usuario.png
">
                        </div>
                            ...
                            <div class="panel panel-info">
                                ...
                                <br><br>
                                    <div class="col-lg-12 col-sm-12 col-12 form-input">
                                        <form class="border p-3 form" method="get" action="../BuscarPaciente">
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label" for="email" style = "padding-top:10px">Correo:</label>
                                                <div class="col-sm-9">
                                                    <input type="email" name="txtUsuario" id="email" class="form-control" placeholder="Ingresa tu correo electrónico">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <div class="form-group col-md-9 enlaces-login">
                                                        <label class="registro"><a href="DatosPaciente.jsp?1=0">Registrarse</a></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                        <label class="colvidada"><a href="ContrasenaOlvidadaPaciente.jsp">Contraseña olvidada</a></label>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
