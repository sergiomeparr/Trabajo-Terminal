...
<html lang="en">
    ...
    <body>
        <%
            ...
            MedicosCRUD crud = new MedicosCRUD();
            String encriptado = null;
            Medicos m = new Medicos();
            m.setIdMedicos(idmedico);
            List<Medicos> lista1 = crud.readMedicos(m);
            Medicos listaMedicos = (Medicos)lista1.get(0);
        %>
        <%if(bandera == 1){%>
            <script>
        ...
        <div class="container-contact100">
            <div class="wrap-contact100">
                <form  action = "../ActualizarDatosMedico" class="contact100-form validate-form" id="smart-form">
                    <span class="contact100-form-title" style="font-family: Verdana; letter-spacing: 0.25em;">
                        <h1><strong>Actualizar datos del médico</strong></h1>
                    </span>

                     <div class="wrap-input100 bg1">
                        <span class="label-input100">Cédula profesional *</span>
                        <input class="input100" type="text" name = "Cedula" value="<%=listaMedicos.getCedulap()%>" minlength="7" maxlength="50" required pattern="[0-9]+"
                        data-rule-required="true"
                        data-rule-number="true"
                        required="true"
                        data-msg-pattern="<h6 style='color:red; font-size:15px'>Ingresa una cédula profesional válida.</h6>"
                        data-msg-required="<h6 style='color:red; font-size:15px'>Por favor ingresa la cédula profesional.</h6>" >
                    </div>
                    
                    <div class="wrap-input100  bg1" >
                        <span class="label-input100">Nombre *</span>
                        <input class="input100" type="text" name = "Nombre" maxlength="45" value="<%=listaMedicos.getNombreMedico()%>" 
                            minlength="3" required pattern="[a-zA-Z ñÑáéíóúÁÉÍÓÚüÜöÖëËäÄãẽÃẼêôàèìòùÀÈÌÒÙ]{3,45}"
                    ...
                    <div class="wrap-input100 bg1 rs1-wrap-input100" >
                        ...
                        <input class="input100" type="text" name = "ApellidoP" maxlength="35" value="<%=listaMedicos.getAPaternoMedico()%>" 
                            minlength="3"  required pattern="[A-Za-z-0-9 ñÑáéíóúÁÉÍÓÚüÜöÖëËäÄãẽÃẼêôàèìòùÀÈÌÒÙ]+"
                    ...
                    <div class="wrap-input100 bg1 rs1-wrap-input100" >
                        ...
                        <input class="input100" type="text" name = "ApellidoM" maxlength="45" value="<%=listaMedicos.getAMaternoMedico()%>" 
                            minlength="3"  required pattern="[A-Za-z-0-9 ñÑáéíóúÁÉÍÓÚüÜöÖëËäÄãẽÃẼêôàèìòùÀÈÌÒÙ]+"
                            title="<h6 style='color:red; font-size:15px'>Sólo letras y espacios, tamaño mínimo: 3, tamaño máximo: 35.</h6>"
                            data-rule-required="true" required="true"
                    ...
                    <div class="wrap-input100 bg1 rs1-wrap-input100" >
                        ...
                        data-rule-required="true" required="true"
                        data-msg-required="<h6 style='color:red; font-size:15px'>Por favor ingresa la especialidad</h6>" >
                            <option><%=listaMedicos.getEspecialidades()%></option>
                    ...
                    <div class="wrap-input100 bg1 rs1-wrap-input100">
                        ...
                        <input class="input100" type="text" name = "Telefono" value="<%=listaMedicos.getTelefonos()%>"  minlength = "8" maxlength="10" required pattern="[0-9]+"                             
                    ...
                    <div class="wrap-input100 bg1">
                        ...
                        <input class="input100" type="text" name = "Historial" maxlength="190" value="<%=listaMedicos.getHistorial()%>" 
                    ...
                    <div class="wrap-input100 bg1">
                        ...
                        <input class="input100" type="email" name = "Email" maxlength="48" value="<%=listaMedicos.getEmail()%>"
