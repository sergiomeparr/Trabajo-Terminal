    ...
    <body>
        ...
        <div class="container-contact100">
            <div class="wrap-contact100">
                <form  action = "../NuevoServicioMedico" class="contact100-form validate-form" id="smart-form">
                    <span class="contact100-form-title" style="font-family: Verdana; letter-spacing: 0.25em;">
                        <h1><strong>Nuevo servicio médico</strong></h1>
                    </span>
                    <div class="wrap-input100 bg1" >
                        <span class="label-input100">Tipo *</span>
                        <input class="input100" type="text" name = "ServicioMedico" value=""
                        minlength="5" maxlength="50" required pattern="[A-Za-z-0-9 áéíóúÁÉÍÓÚñÑ,.]+"
                    ...
                    <div class="wrap-input100  bg1" >
                        ...
                        <input class="input100" type="number" name = "ServicioMedicoPrecio" maxlength="9" value="" min="0" step="0.01" pattern="[0-9.,]+">
                    </div>
