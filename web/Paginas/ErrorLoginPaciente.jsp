...
<html>
    ...
    <body>
        <% int intentos = Integer.parseInt(request.getParameter("a")); %>
                            ...
                            <div class="panel panel-info">
                                ...
                                <br><br>
                                    <div class="col-lg-12 col-sm-12 col-12 form-input">
                                        <form class="border p-3 form" method="post" action="../BuscarPaciente">
                                            ...
                                            <input type ="hidden" name ="a" value='<%=intentos%>' 
                                        </form>
                                    </div>
                                </div>
                            </div>
