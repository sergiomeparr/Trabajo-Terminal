                    ...
                    <div class="col-lg-12 col-sm-12 col-12 main-section">
                        <div class="panel-group">
                            <div class="panel panel-info">
                                ...
                                <div style="float:right; font-size: 80%; position: relative; top:-20px"><a href="LoginPaciente.jsp">Iniciar sesi&oacute;n</a></div>
                                <div class="panel-body contenido-panel">
                                    <br><br>
                                    <div class="col-lg-12 col-sm-12 col-12 form-input">
                                        <form id="loginform" class="form-horizontal" action="../EnviarCorreo" method="post">

                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                                <input id="email" type="email" class="form-control col-sm" name="Email" placeholder="Correo electrónico" required>                                        
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-12 control" align ="left">
                                                    <div style="border-top: 1px solid#888; padding-top:15px; font-size:85%" >
                                                        No tiene una cuenta! <a href="DatosPaciente.jsp?1=0">Registrate aquí</a>
                                                    </div>
                                                </div>
                                            </div>    
                                        </form>
